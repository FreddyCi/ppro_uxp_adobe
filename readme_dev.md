...
Are removed if the variable doesn't match the framework (e.g. React, Vue, Svelte), app (e.g. Premiere Pro, InDesign, etc.), or feature (e.g. Hybrid) selected.

_Note: Swap `VARIABLE` with the variable name (e.g. ``, etc.)_
